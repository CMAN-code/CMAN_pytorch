...
from datasets.transforms import ToFloatTensor2D, AddNoise
...
class CIFAR10(OneClassDataset):
    ...
    def __init__(self, path):
        ...
        self.train_split = datasets.CIFAR10(self.path, train=True, download=False, transform=None)
        self.test_split = datasets.CIFAR10(self.path, train=False, download=False, transform=None)
        ...
        # self.train_transform =  transforms.Compose([ToFloatTensor2D(), AddNoise(0.025)])
