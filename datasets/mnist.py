...
class MNIST(OneClassDataset):
    ...
    def __init__(self, path):
        ...
        self.train_split = datasets.MNIST(self.path, train=True, download=False, transform=None)
        self.test_split = datasets.MNIST(self.path, train=False, download=False, transform=None)
